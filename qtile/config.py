...
groups = [
    Group("[1] IA", layout="max"),
    Group("[2] BACK", layout="max"),
    Group("[3] FRONT", layout="max"),
    Group("[4] WEB", layout="max"),
    Group("[5] TEST", layout="max"),
    Group("[6] DB", layout="max"),
    Group("[7] DOC", layout="max"),
    Group("[9] CHAT", layout="max"),
]
